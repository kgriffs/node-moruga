...
exports.listen = function (options) {
  ...
  // Set context for each request and fudge the host
  var targetHost = url.parse(options.url).host;
  app.use(function(req, res, next) {
    req.x_context = { verbose: options.verbose, originalHost: req.headers.host};
