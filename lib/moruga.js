...
var _install_filters = function (filters, app) {
...
var _init = function(options) {
  if (options.filters) {
    ...
    try {
      options.filters = require(filters_filename).filters;
    }
    catch (ex) {
...
exports.listen = function (options) {
  ...
  if (options.filters) _install_filters(options.filters, app);

  app.use(require('./echo')(options.url));
